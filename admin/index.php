						...
						<div class="meta-box-sortables ui-sortable">
								...
								<div class="postbox closed">
									<button type="button" class="handlediv" aria-expanded="false"><span class="screen-reader-text">' . esc_html__( 'Toggle panel: Frontend Options', 'all-in-one-schemaorg-rich-snippets' ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>
										...
										<p>' . esc_html__( 'Here is a reference link of what Google says: ', 'all-in-one-schemaorg-rich-snippets' ) . '<a href="https://sites.google.com/site/webmasterhelpforum/en/faq-all-in-one-schemaorg-rich-snippets#display" target="_blank"> https://sites.google.com/site/webmasterhelpforum/en/faq-all-in-one-schemaorg-rich-snippets#display</a></p>
