										...
										<input type="hidden" id="snippet_review_nonce_field" name="snippet_review_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_review_form_action' ) ) . '" />
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="item_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=review&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_item_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_event_nonce_field" name="snippet_event_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_event_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="event_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=event&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_event_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_person_nonce_field" name="snippet_person_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_person_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="person_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=person&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_person_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_product_nonce_field" name="snippet_product_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_product_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="product_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=product&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_product_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_recipe_nonce_field" name="snippet_recipe_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_recipe_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="recipe_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=recipe&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_recipe_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_soft_app_nonce_field" name="snippet_soft_app_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_soft_app_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="software_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=software&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_software_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_video_nonce_field" name="snippet_video_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_video_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="video_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=video&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_video_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_article_nonce_field" name="snippet_article_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_article_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="article_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=article&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_article_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
										...
										<input type="hidden" id="snippet_service_nonce_field" name="snippet_service_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_service_form_action' ) ) . '">
											<table class="bsf_metabox">
												<tbody>
													...
													<tr>
														<td></td>
														<td><input type="submit" class="button-primary" name="service_submit" value="' . esc_html__( 'Update ', 'rich-snippets' ) . '"/>&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=service&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_service_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
													</tr>
												</tbody>
											</table>
										</form>
						...
						<div class="meta-box-sortables ui-sortable">
								...
								<div class="postbox closed">
									<button type="button" class="handlediv" aria-expanded="false"><span class="screen-reader-text">' . esc_html__( 'Toggle panel: Frontend Options', 'rich-snippets' ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>
										...
										<div class="inside">
										<p>' . esc_html__( 'We understand that you don\'t like the content that gets displayed on your page / post. However, as per the strong recommendation of Google, MicroData should be clearly visible to the user.', 'rich-snippets' ) . '</p>
										<p>' . esc_html__( 'Here is a reference link of what Google says: ', 'rich-snippets' ) . '<a href="https://sites.google.com/site/webmasterhelpforum/en/faq-rich-snippets#display" target="_blank"> https://sites.google.com/site/webmasterhelpforum/en/faq-rich-snippets#display</a></p>
										<p>' . sprintf( esc_html__( 'If you still do not want your schema markup to affect your frontend design, you can use %1$sSchema Pro%2$s - our advanced Schema markup plugin that is built with the latest JSON-LD technology which does not require a content box to be displayed on the front-end.', 'rich-snippets' ), '<a href="https://wpschema.com/?utm_source=allinone&utm_campaign=repo&utm_medium=faq" target="_blank">', '</a>' ) . '</p>
										</div>
								</div>
								<div class="postbox closed">
									<button type="button" class="handlediv" aria-expanded="false"><span class="screen-reader-text">' . esc_html__( 'Toggle panel: Frontend Options', 'rich-snippets' ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>
								...
								<div class="postbox closed">
									<button type="button" class="handlediv" aria-expanded="false"><span class="screen-reader-text">' . esc_html__( 'Toggle panel: Frontend Options', 'rich-snippets' ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>
										...
										<div class="inside">
										<p>' . esc_html__( 'We cannot assure the time it will take to display a rich snippet for your search results. This is completely dependent on when your website is crawled by the search engine. However, there are many more factors, such as your website authority that contribute to the time taken for your website to be crawled and a rich snippet displayed.', 'rich-snippets' ) . '</p>
										<p>' . esc_html__( 'If rich snippets are not appearing in your search results as of yet, most probably they might start appearing as soon as Google or other search engines find your website more authoritative.', 'rich-snippets' ) . '</p>
										<p>' . sprintf( esc_html__( 'Meanwhile - you can validate and see the preview of your rich snippets on %1$s[ Google Structured Data Testing Tool ]%2$s.', 'rich-snippets' ), '<a target="_blank" href="http://www.google.com/webmasters/tools/richsnippets">', '</a>' ) . '</p> 
										</div>
								</div>
								<div class="postbox closed">
									<button type="button" class="handlediv" aria-expanded="false"><span class="screen-reader-text">' . esc_html__( 'Toggle panel: Frontend Options', 'rich-snippets' ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>
					...
					<div id="poststuff">
						<div id="postbox-container-11" class="postbox-container">
							<div class="meta-box-sortables ui-sortable">
								<div class="postbox">
									<button type="button" class="handlediv" aria-expanded="false"><span class="screen-reader-text">' . esc_html__( 'Toggle panel: Frontend Options', 'rich-snippets' ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>
										<h3 class="hndle">' . wp_kses_post( __( '<span>Customize the look and feel of rich snippet box</span>', 'rich-snippets' ) ) //phpcs:ignore WordPress.WP.I18n.NoHtmlWrappedStrings
										. '</h3>
										<div class="inside">
											...
											<table class="bsf_metabox">
												...
												<tr>
													<td></td>
													<td><input id="submit_colors" class="button-primary" type="submit" value="' . esc_attr__( 'Update Colors', 'rich-snippets' ) . '" />&nbsp;&nbsp;&nbsp;<a class="button-primary" href="?page=rich_snippet_dashboard&amp;action=reset&options=color&nonce=' . esc_attr( wp_create_nonce( 'aiosrs_color_nonce' ) ) . '">' . esc_html__( 'Reset ', 'rich-snippets' ) . '</a></td>
												</tr>
											</table>
											</form>
										</div>
				...
				<table class="bsf_metabox" > <input type="hidden" name="site_url" value="' . esc_url( site_url() ) . '" /> </p>
					<tr>
						<td>
							...
							<label for="woocommerce_option">' . esc_html__( 'Enable schema on WooCommerce products', 'rich-snippets' ) . '</label>
						</td>
					</tr>
					<tr>
						<td>
...
if ( isset( $_GET['action'] ) ) {
	if ( 'reset' === esc_attr( $_GET['action'] ) && isset( $_GET['nonce'] ) && current_user_can( 'manage_options' ) ) {
		...
		if ( 'review' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_item_nonce' ) ) {
			delete_option( 'bsf_review' );
		}
		if ( 'event' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_event_nonce' ) ) {
			delete_option( 'bsf_event' );
		}
		if ( 'person' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_person_nonce' ) ) {
			delete_option( 'bsf_person' );
		}

		if ( 'product' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_product_nonce' ) ) {
			delete_option( 'bsf_product' );
		}
		if ( 'recipe' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_recipe_nonce' ) ) {
			delete_option( 'bsf_recipe' );
		}
		if ( 'software' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_software_nonce' ) ) {
			delete_option( 'bsf_software' );
		}
		if ( 'video' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_video_nonce' ) ) {
			delete_option( 'bsf_video' );
		}

		if ( 'article' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_article_nonce' ) ) {
			delete_option( 'bsf_article' );
		}
		if ( 'service' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_service_nonce' ) ) {
			delete_option( 'bsf_service' );
		}

		if ( 'color' === $option_to_reset && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['nonce'] ) ), 'aiosrs_color_nonce' ) ) {
			...
			<input type="hidden" id="aiosrs_support_form_nonce" name="aiosrs_support_form_nonce" value="' . esc_attr( wp_create_nonce( 'aiosrs_support_form' ) ) . '" />
				...
				<table class="bsf_metabox" > <input type="hidden" name="site_url" value="' . esc_url( site_url() ) . '" /> </p>
					...
					<tr><td class="bsf_label"><label for="message"><strong>' . esc_html__( 'Your Query in Brief:', 'rich-snippets' ) . '</strong> </label></td>
						...
						<tr></tr> <tr></tr> <tr></tr>
					<tr><td></td>
						<input id="submit_request" class="button-primary" type="submit" value="' . esc_attr__( 'Submit Request', 'rich-snippets' ) . '" /> <span id="status"></span></td></tr>
				</table>
			</form>
			</div>
		</div>
