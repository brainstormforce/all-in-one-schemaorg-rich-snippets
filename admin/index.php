		...
		<div class="postbox bsf-woocommerce-setting closed">
            ...
            <input type="hidden" id="snippet_analytics_nonce_field" name="snippet_analytics_nonce_field" value="' . esc_attr( wp_create_nonce( 'snippet_analytics_form_action' ) ) . '">
                <table class="bsf_metabox" > <input type="hidden" name="site_url" value="' . esc_url( site_url() ) . '" /> </p>
                    <tr>
                        <td>
                            <input type="checkbox" name="aiosrs_usage_optin" id="aiosrs_usage_optin" value="yes" ' . checked( 'yes', get_option( 'aiosrs_usage_optin', 'no' ), false ) . ' />
...
if ( isset( $_POST['setting_analytics_submit'] ) ) {
	if ( ! isset( $_POST['snippet_analytics_nonce_field'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['snippet_analytics_nonce_field'] ) ), 'snippet_analytics_form_action' ) || ! current_user_can( 'manage_options' )
		...
		if ( isset( $_POST['aiosrs_usage_optin'] ) ) {
			update_option( 'aiosrs_usage_optin', 'yes' );
		} else {
			update_option( 'aiosrs_usage_optin', 'no' );
		}
	}
}
