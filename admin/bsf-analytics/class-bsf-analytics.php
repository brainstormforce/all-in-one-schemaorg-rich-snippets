	...
	class BSF_Analytics {
		...
		public function option_notice() {
			...
			foreach ( $this->entities as $key => $data ) {
				...
				$notice_string = wp_kses_post(__( 'Want to help make <strong>%s</strong> even more awesome? Allow us to collect non-sensitive diagnostic data and usage information. ', 'all-in-one-schemaorg-rich-snippets' ));
