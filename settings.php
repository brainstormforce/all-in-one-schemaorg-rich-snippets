 ...
 */
function add_review_option(): void {
	$review_opt = [
 ...
 */
function add_event_option(): void {
	$event_opt = [
 ...
 */
function add_person_option(): void {
	$person_opt = [
		'snippet_title'    => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 */
function add_product_option(): void {
	$product_opt = [
		'snippet_title'  => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 */
function add_recipe_option(): void {
	$recipe_opt = [
		'snippet_title'     => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 */
function add_software_option(): void {
	$software_opt = [
		'snippet_title'    => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 */
function add_video_option(): void {
	$video_opt = [
		'snippet_title' => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 */
function add_article_option(): void {
	$article_opt = [
		'snippet_title'          => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 *  Function to add article option for settings.
 */
function add_service_option(): void {
	$service_opt = [
		'snippet_title'         => __( 'Summary', 'all-in-one-schemaorg-rich-snippets' ),
 ...
 */
function add_color_option(): void {
	$color_opt = [
 ...
 *  Function for customization
 */
function add_woo_commerce_option(): void {
